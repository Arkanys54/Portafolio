...
export const projects = [
  {
    ...
    screenshots: [
      { src: guiasAppHome, alt: 'App móvil — pantalla de inicio de guías clínicas', device: 'phone' },
      { src: guiasAppBusqueda, alt: 'App móvil — búsqueda inteligente', device: 'phone' },
      { src: guiasAppAlgoritmos, alt: 'App móvil — algoritmos clínicos', device: 'phone' },
      { src: guiasAppAlertas, alt: 'App móvil — alertas clínicas', device: 'phone' },
      { src: guiasAppAsistente, alt: 'App móvil — asistente clínico', device: 'phone' },
      { src: guiasAdminGuias, alt: 'Panel admin — gestión de guías', device: 'browser' },
      { src: guiasAdminCasos, alt: 'Panel admin — casos clínicos', device: 'browser' },
      { src: guiasAdminAlgoritmos, alt: 'Panel admin — editor de algoritmos clínicos', device: 'browser' },
    ],
  ...
  },
  {
    ...
    credentials: null,
    screenshots: [
      { src: lingualeapInicio, alt: 'Página de inicio de LinguaLeap', device: 'browser' },
      { src: lingualeapNiveles, alt: 'Selección de niveles A1–C2', device: 'browser' },
      { src: lingualeapTemas, alt: 'Temas y lecciones', device: 'browser' },
      { src: lingualeapHabla, alt: 'Práctica de expresión oral', device: 'browser' },
      { src: lingualeapPreguntas, alt: 'Ejercicios de preguntas', device: 'browser' },
    ],
  },
  {
    id: 'red-de-ventas',
    ...
    screenshots: [
      { src: redInicio, alt: 'Pantalla de inicio de Red de Ventas', device: 'browser' },
      { src: redAdmin, alt: 'Panel del administrador', device: 'browser' },
      { src: redLider, alt: 'Panel del líder', device: 'browser' },
      { src: redLiderEquipo, alt: 'Ventas del equipo (vista de líder)', device: 'browser' },
      { src: redVendedor, alt: 'Panel del vendedor', device: 'browser' },
      { src: redVendedorPedidos, alt: 'Pedidos del vendedor', device: 'browser' },
      { src: redReportes, alt: 'Reportes del sistema', device: 'browser' },
    ],

/**
 * Iconos de marca (GitHub, LinkedIn) como SVG propios.
 * lucide-react ya no incluye logos de marca, así que los definimos aquí
 * respetando su misma API (className, ...props) para no mezclar librerías.
 */
